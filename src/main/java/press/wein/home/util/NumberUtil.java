...
public class NumberUtil {
    ...
    public static final String DEFAULT_PERCENT = "0.00%";
     ...
     * 两个数字是否相等
     */
    public static boolean beEquals(Short n1, Short n2) {
     ...
     * 两个数字是否相等
     */
    public static boolean beEquals(Integer n1, Integer n2) {
        return equalsImpl(n1, n2);
    }
     ...
     * 两个数字是否相等
     */
    public static boolean beEquals(Long n1, Long n2) {
        return equalsImpl(n1, n2);
    }
     ...
     * 两个数字是否相等
     */
    public static boolean beEquals(Double n1, Double n2) {
        return equalsImpl(n1, n2);
    }
