			...
			<div role="navigation" class="navbar navbar-default topnav">
				<div class="container">
					<div class="navbar-header">
						...
						<span class="navbar-brand" class="navbar-brand"><img src="images/icon.png" /></span>
					</div>
					<div id="navbar" class="navbar-collapse collapse">
						<div class="navbar-right">
							<ul class="nav navbar-nav">
								<c:choose>
									<c:when test="${(!empty username)&&(role eq '3')}">
										<li class=""><span>欢迎你，打印机 ${username}</span></li>
										<li class=""><a href="jsp/users/logout.jsp">退出</a></li>
									</c:when>
									<c:otherwise>
									    <li class="" id="login-li"><a href="jsp/printer/printerLogin.jsp">登录</a></li>
									</c:otherwise>
								</c:choose>
							</ul>
						</div>
